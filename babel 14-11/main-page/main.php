    ...
    <div class="celular-caja">
     ...
     <div class="encabezado">
        ...
        <nav class="navbar" id="nav" >
            ...
            <ul class="nav-list">
                <li>
                    <a href="../menu-hamburguesa/cuenta.php"><button><p>Cuenta</p></button></a>
                </li>
                <li>
                    <a href="../menu-hamburguesa/idiomas.html"><button><p>Idiomas</p></button></a>
                </li>
                <li>
                    <a href="../menu-hamburguesa/reporte.html"><button><p>Reportar un problema</p></button></a>
                </li>
                <li>
                    <a href="../inicio-sesion/inicioSesion.html"><button><p>Iniciar sesion</p></button></a>
                </li>  
                <li>
                    <a href="../inicio-sesion/registro.html"><button><p>Registrarse</p></button></a>
                </li>    
            </ul>
        </nav>
    </div>
        ...
        <div class="cajas-cont">
            ...
            <div class="caja-chat">
                <a href="../verhistorial.php"><button>Historial</button></a>
            </div>
            <div class="caja-chat">
                <a href="../correcion/correccion.html"><button>Corrección gramatical</button></a>
            </div>
            <div class="caja-chat">
                <a href="#"><button>Traducción de imagen</button></a>
            </div>
        </div>
